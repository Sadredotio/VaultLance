    ...
    <AuthProvider>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/contract-details/:contractId" element={
            <ProtectedRoute>
              <ContractDetails />
            </ProtectedRoute>
          } />
          
          <Route path="/submit-work/:contractId" element={
            <ProtectedRoute requiredRole="freelancer">
              <SubmitWork />
            </ProtectedRoute>
          } />
          
          <Route path="/approve-work/:contractId" element={
          ...
          <Route path="/fund-contract/:contractId" element={
            <ProtectedRoute requiredRole="client">
              <FundContract />
            </ProtectedRoute>
          } />
          ...
          <Route path="/freelancer-profile/:freelancerId" element={
            <ProtectedRoute>
              <FreelancerProfile />
            </ProtectedRoute>
          } />
